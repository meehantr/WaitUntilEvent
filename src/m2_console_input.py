...
def double_a_float():
    ...
    # ------------------------------------------------------------------
    x = float(input('Insert float here. '))
    print(2 * x)
...
def print_an_integer_many_times():
    ...
    #   The testing code is already written for you (above).
    # ------------------------------------------------------------------
    x = int(input('Put positive integer here. '))
    for i in range(x):
        print(2 * x)
...
def print_an_integer_many_times_on_one_row():
    ...
    # ------------------------------------------------------------------
    x = int(input('Put integer here. '))
    string_to_print = ''
    for i in range(x):
        string_to_print = string_to_print + str(2 * x)
...
def input_it_all():
    ...
    number = float(input('Put float here. '))
    integer = int(input('Put integer here. '))
    string = str(input('Put string here. '))
